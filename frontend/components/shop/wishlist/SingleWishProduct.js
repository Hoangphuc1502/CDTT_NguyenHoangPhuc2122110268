...
const Product = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const responseData = await WishlistService.getProducts();
    ...
    <Fragment>
      <div className="grid grid-cols-2 md:grid-cols-1">
        {products.length > 0 ? (
            ...
            >
              ...
              <div className="md:w-1/2 md:flex md:items-center">
                <img
                  ...
                  src={`${API_URL}/uploads/products/${product.pImages[0]}`}
                  alt={product.pName}
                />
          ...
          <div className="col-span-2 md:col-span-1 my-10 text-center text-xl">
